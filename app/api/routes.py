...
# purpose of api is going to be to hold a database of products that we will use on our mock ecommerce store that we will create in React
# we are making a CRUD API that can create read and/or delete Animals from our database
# what do we need? what is required? what can be changed? what can be changed?
